    ...
    <body>
        ...
        <div class="container">
            ...
            <form id="myForm1">
                <div class="row">
                    <div class="col">
                        <button type="button" class="btn btn-success" onclick="document.getElementById('myForm1').action='vehiclereg.jsp'; document.getElementById('myForm1').target='_self'; document.getElementById('myForm1').submit();">Vehicle Registration</button>
                    </div>
                    <div class="col">
